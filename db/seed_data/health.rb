...
food_1_path = open('')
food_1.picture.attach(io: food_1_path, filename: '')
...
food_2_path = open('https://blogium-pro.s3-us-west-1.amazonaws.com/food/food_2.jpg')
food_1.picture.attach(io: food_2_path, filename: 'food_2.jpg')
------------------------------
work_1 = Post.create!({
...
work_1_path = open('')
work_1.picture.attach(io: work_1_path, filename: 'work_1.jpg')
------------------------------------------
work_2 = Post.create!({
